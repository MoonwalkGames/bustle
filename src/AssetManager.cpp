...
void AssetManager::loadAssets()
{
	...
	loadedMeshes.push_back(Mesh("./res/mesh/mesh_BackBuilding1.obj"));
	loadedMeshes.push_back(Mesh("./res/mesh/mesh_BackBuilding2.obj"));
	...
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding1_Red.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding1_Blue.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding1_Green.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding1_Yellow.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding2_Red.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding2_Blue.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding2_Green.png"));
	loadedTextures.push_back(Texture2D("./res/img/tex_BackBuilding2_Yellow.png"));
