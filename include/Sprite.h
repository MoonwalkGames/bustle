...
public:
	...
	static std::vector<Sprite> Sprite::createTextVector(TEXTURE_NAME fontSheet, float posX, float posY, float posz, float scaleX, float scaleY, std::string text); //for non billboards
	static std::vector<Sprite> Sprite::createTextVector(TEXTURE_NAME fontSheet, float posX, float posY, float posz, float scaleX, float scaleY, std::string text, glm::vec3 cameraPos, glm::vec3 cameraLookAtPos); //for billboards
